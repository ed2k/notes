...
#define __local
typedef union uint2_u {
    uint64_t v;
    struct {uint32_t x; uint32_t y;};
} u2;
typedef union uint4_u {
    unsigned __int128 v;
...
__constant uint2 const Keccak_f1600_RC[24] = {
	unt2(0x00000001, 0x00000000),
	unt2(0x00008082, 0x00000000),
	unt2(0x0000808a, 0x80000000),
	unt2(0x80008000, 0x80000000),
	unt2(0x0000808b, 0x00000000),
	unt2(0x80000001, 0x00000000),
	unt2(0x80008081, 0x80000000),
	unt2(0x00008009, 0x80000000),
	unt2(0x0000008a, 0x00000000),
	unt2(0x00000088, 0x00000000),
	unt2(0x80008009, 0x00000000),
	unt2(0x8000000a, 0x00000000),
	unt2(0x8000808b, 0x00000000),
	unt2(0x0000008b, 0x80000000),
	unt2(0x00008089, 0x80000000),
	unt2(0x00008003, 0x80000000),
	unt2(0x00008002, 0x80000000),
	unt2(0x00000080, 0x80000000),
	unt2(0x0000800a, 0x00000000),
	unt2(0x8000000a, 0x80000000),
	unt2(0x80008081, 0x80000000),
	unt2(0x00008080, 0x80000000),
	unt2(0x80000001, 0x00000000),
	unt2(0x80008008, 0x80000000),
};

static uint2 ROL2(const uint2 vv, const int n)
{
	u2 result;
    u2 v; v.v = vv;
	if (n <= 32)
...
static uint fnv_reduce(uint4 vv)
{
    u4 v; v.v = vv;
